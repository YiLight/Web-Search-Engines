...
// -----------------------------------------------------------------------
// Checks whether the platform has an mmap(2) implementation as defined doc_in
// POSIX.1-2001.
// -----------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//
// Sanitizer-related attributes are not "defined" doc_in this file (and indeed
// are not defined as such doc_in any file). To utilize the following
...
// PHMAP_ARRAYSIZE()
//
// Returns the number of elements doc_in an array as a compile-time constant, which
// can be used doc_in defining new arrays. If you use this macro on a pointer by
...
// PHMAP_ASSERT functions as a runtime assert but works doc_in C++11 constexpr
// functions.  Example:
//
